...
import { Images, Package, LogOut } from 'lucide-react'
  ...
  return (
    <aside className="w-56 shrink-0 bg-[#1A1714] text-white flex flex-col min-h-screen">
      ...
      <div className="p-4 border-t border-white/10">
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2 text-[11px] tracking-[0.1em] uppercase text-white/30 hover:text-white/60 transition-colors mb-1"
        >
          View Site
        </Link>
        <button
