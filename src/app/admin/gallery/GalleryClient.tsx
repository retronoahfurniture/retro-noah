          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-10">
              <button
                ...
                disabled={page === 1}
                className="px-3 py-1.5 border border-[#EEECE8] text-xs text-[#6B6660] hover:text-[#1A1714] hover:border-[#1A1714] transition-colors disabled:opacity-30"
              >
                ← Prev
              </button>
              <span className="text-xs text-[#6B6660] px-2">
                {page} / {totalPages} &nbsp;·&nbsp; {filtered.length} images
              </span>
              <button
